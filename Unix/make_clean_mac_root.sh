...
#rm -rvf /var/lib/SurroundSCM/    #linux only

#mac only###
rm -rvf "/Applications/Surround SCM"
rm -rvf /Library/PreferencePanes/SSCMPreference.prefPane
rm -rvf /Library/PreferencePanes/SSCMProxyPreference.prefPane
############

rm -vf /var/log/SCMStartup.log
rm -vf /etc/init.d/surroundscm
rm -vf /etc/spscm.conf
rm -vf /etc/spscmproxy.conf
...
#rm -rvf /var/lib/TestTrack    #linux only

#mac only ######
rm -rvf /Applications/TestTrack    
...
#rm -rvf /var/lib/splicsvr    #linux only


#mac only #######
rm -rvf "/Applications/Seapine License Server"    #mac only
rm -rvf /Library/PreferencePanes/LSPreference.prefPane
rm -vf /etc/splicsvrclient.conf
