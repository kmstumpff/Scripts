...
try:
	for i in range(1,334):
		...
		res = f.read()
		f.close()
	print('Mainline bookmarks added')
except urllib2.URLError as e:
    print(e)
# Repository
try:
	for i in range(1,334):
		f = opener.open( webAddress + "/sscmweb/api/addBookmark?bookmark=%7B%22branch%22:%22Mainline%22,%22path%22:%22Mainline%2Frepo1%2Frepo3%22,%22type%22:%22repository%22,%22location%22:%22Mainline::Mainline%2Frepo1%2Frepo3%22,%22name%22:%22Repository-Bookmark-" + str(i) + "%22,%22description%22:%22This-Bookmark-is-bookmark-" + str(i) + "%22%7D")
		res = f.read()
		f.close()
	print('Repository bookmarks added')
except urllib2.URLError as e:
	print(e)
# File
try:
	for i in range(1,335):
		f = opener.open( webAddress + "/sscmweb/api/addBookmark?bookmark=%7B%22branch%22:%22Mainline%22,%22path%22:%22Mainline%2FRepository%2FFile.txt%22,%22type%22:%22file%22,%22location%22:%22Mainline::Mainline%2FRepository%2FFile.txt%22,%22name%22:%22File-Bookmark-" + str(i) + "%22,%22description%22:%22This-Bookmark-is-bookmark-" + str(i) + "%22%7D")
		res = f.read()
		f.close()
	print('File bookmarks added')
except urllib2.URLError as e:
	print(e)
try:
